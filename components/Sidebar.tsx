...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Menu Button */}
      <button
        className="fixed top-4 left-4 z-50 md:hidden bg-secondary p-2 rounded-lg"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:relative h-screen w-64 bg-gradient-to-b from-primary to-gray-900 border-r border-secondary/20 transition-transform duration-300 z-40 ${
      ...
      >
        <div className="p-8">
          ...
          <Link href="/" className="block mb-12">
            ...
            <p className="text-xs text-gray-400 mt-2">Portfolio</p>
          </Link>
